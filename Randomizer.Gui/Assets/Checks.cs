...
namespace TPRandomizer
{
    public class Checks
    {
        public static List<string> RandomizerChecks = new List<string>()
        {
            ...
            "Gerudo Desert North Small Chest Before Bublin Camp",
            "Bublin Camp First Chest Under Tower At Entrance",
            "Bublin Camp Small Chest in Back of Camp",
            ...
            "Bublin Camp Roasted Boar",
            "Snowpeak Ruins Mansion Map",
            "Snowboard Racing Prize",
            "Hyrule Castle King Bublin Key",
